...
Renesas RZ MPU. */
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS				0x10040000			// CPU Interface Base
#define configINTERRUPT_CONTROLLER_CPU_INTERFACE_OFFSET 	0x1000		// Distributor Offset
#define configUNIQUE_INTERRUPT_PRIORITIES					32

// #define PROCESS_KBD_DATA
