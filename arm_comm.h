...
#if __CORE__ < 7
#pragma arm
__inline Int32U AtomicExchange (Int32U State, pInt32U Flag)
{
  asm("swp  r0, r0, [r1]");
  return(State);
}
...
__inline Int32U EntrCritSection(void)
{
unsigned long tmp;
  tmp = __get_CPSR();
...
__inline void ExtCritSection(Int32U Save)
{
unsigned long tmp;
  tmp = __get_CPSR();
...
__inline Int32U EntrCritSectionFiq(void)
{
unsigned long tmp;
  tmp = __get_CPSR();
...
__inline void ExtCritSectionFiq(Int32U Save)
{
unsigned long tmp;
  tmp = __get_CPSR();
...
__inline void EntrCritSection(void)
{
...
__inline void ExtCritSection(void)
{
  if(--CriticalSecCntr == 0)
  {
    asm("CPSIE i");
