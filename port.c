...
/* In case security extensions are implemented. */
	...
	extern void Timer_Clear_INT(void);
	#define configCLEAR_TICK_INTERRUPT() Timer_Clear_INT();
#endif
...
// uint32_t ulICCPMR = ( ( ( portICCPMR_PRIORITY_MASK_REGISTER_ADDRESS ) ) );
//const uint32_t ulAsmAPIPriorityMask = ( ( ( configMAX_API_CALL_INTERRUPT_PRIORITY << portPRIORITY_SHIFT ) ) );
